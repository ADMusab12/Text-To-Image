...
import com.codetech.texttoimage.databinding.ActivityPresidentBinding
...
class PresidentActivity : AppCompatActivity() {
    private val binding by lazy {ActivityPresidentBinding.inflate(layoutInflater)}
    ...
    private fun generateImage(prompt: String) {
        ...
        imageGenerator.generateImage(prompt,"president") { bitmap ->
            if (bitmap != null) {
